---
title: "Switching video sources in Traffic Reducer"
...
- After **3 consecutive failures**, the dashboard surface-level badge switches to `● INACTIVO` and the UI suggests switching to local video.
