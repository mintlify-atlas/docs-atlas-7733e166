---
title: "Manual simulation mode: test signal decisions"
...
To quickly generate a realistic but random traffic scenario, use the **Activar Control** button while live mode is **off**, or call the `/simulate` endpoint directly:
