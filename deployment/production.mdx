---
title: "Deploying Traffic Reducer to a production server environment"
sidebarTitle: "Production"
description: "Run Traffic Reducer reliably in production: disable Flask debug mode, add GPU acceleration, configure a WSGI server, and set up a persistent service."
---
