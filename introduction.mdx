...
description: "Traffic Reducer replaces static timers with YOLOv8 computer vision that counts vehicles per lane and selects the optimal green-light direction in real time."
---
