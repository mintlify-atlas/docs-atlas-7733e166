...
description: "Traffic Reducer uses a majority-rule algorithm — the lane with the most detected vehicles wins the green light — with sklearn model support for phase classification."
---
