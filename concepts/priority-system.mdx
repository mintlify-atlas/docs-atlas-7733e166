...
description: "How Traffic Reducer detects pedestrians and emergency vehicles to trigger immediate priority overrides that supersede normal majority-rule signal decisions."
---
